        ...
        <div className="md:navbar-end ">
          <div className="w-full lg:navbar-start">
            <div className="dropdown">
              ...
              <ul
                tabIndex={0}
                className="menu menu-sm dropdown-content mt-3 z-[1] shadow bg-black rounded-box w-52"
              >
                {navLinks}
              </ul>
            </div>
          ...
          <div className="flex justify-center items-center">
            <div className="navbar-center hidden lg:flex">
              <ul className="menu menu-horizontal px-1 items-center gap-2 font-bold">
                {navLinks}
                {user && (
          ...
          <label className="swap swap-rotate md:ml-7 mb-0 md:mb-1">
